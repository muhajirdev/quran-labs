...
export const AGENT_REGISTRY: AgentDefinition[] = [
  {
    ...
    description: "A general-purpose SuperQuran assistant",
    icon: "Bot",
    iconColor: "#4F46E5",
