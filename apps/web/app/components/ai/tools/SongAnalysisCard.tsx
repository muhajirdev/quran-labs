...
export function SongAnalysisCard({
  ...
  const getGradientBackground = (slide: SongAnalysisResult["slides"][0]) => {
    const gradients = {
      ...
      lyric_quote: {
        contemplative: "from-slate-500 via-blue-600 to-indigo-700",
        uplifting: "from-orange-500 via-red-500 to-pink-600",
        comforting: "from-purple-500 via-pink-600 to-red-600",
        inspiring: "from-green-500 via-teal-600 to-blue-700",
        reflective: "from-gray-500 via-slate-600 to-blue-700",
      },
      // Emotional Reflection - Heart colors
      emotional_reflection: {
        contemplative: "from-rose-500 via-purple-600 to-indigo-700",
        uplifting: "from-amber-500 via-orange-600 to-pink-700",
        comforting: "from-pink-500 via-rose-600 to-purple-700",
        inspiring: "from-emerald-500 via-teal-600 to-cyan-700",
        reflective: "from-blue-500 via-indigo-600 to-purple-700",
      },
      // Quranic Wisdom - Sacred colors
      quranic_wisdom: {
        contemplative: "from-emerald-600 via-teal-700 to-cyan-800",
        uplifting: "from-yellow-500 via-green-600 to-emerald-700",
        comforting: "from-blue-500 via-indigo-600 to-purple-700",
        inspiring: "from-cyan-500 via-blue-600 to-indigo-700",
        reflective: "from-slate-500 via-gray-600 to-blue-700",
      },
      // Personal Story - Warm human colors
      personal_story: {
        contemplative: "from-orange-500 via-red-600 to-pink-700",
        uplifting: "from-yellow-500 via-orange-600 to-red-700",
        comforting: "from-pink-500 via-purple-600 to-indigo-700",
        inspiring: "from-green-500 via-emerald-600 to-teal-700",
        reflective: "from-gray-500 via-slate-600 to-indigo-700",
      },
      // Hope Message - Bright, optimistic
      hope_message: {
        contemplative: "from-blue-500 via-cyan-600 to-teal-700",
        uplifting: "from-yellow-500 via-orange-600 to-pink-700",
        comforting: "from-purple-500 via-pink-600 to-rose-700",
        inspiring: "from-green-500 via-emerald-600 to-cyan-700",
        reflective: "from-indigo-500 via-purple-600 to-pink-700",
      },
      // Practical Guidance - Earthy, grounding
      practical_guidance: {
        contemplative: "from-stone-600 via-gray-700 to-slate-800",
        uplifting: "from-amber-500 via-yellow-600 to-orange-700",
        comforting: "from-rose-500 via-pink-600 to-purple-700",
        inspiring: "from-lime-500 via-green-600 to-emerald-700",
        reflective: "from-blue-500 via-slate-600 to-gray-700",
      },
      // Spiritual Insight - Transcendent colors
      spiritual_insight: {
        contemplative: "from-violet-500 via-purple-600 to-indigo-700",
        uplifting: "from-cyan-500 via-blue-600 to-indigo-700",
        comforting: "from-pink-500 via-rose-600 to-purple-700",
        inspiring: "from-emerald-500 via-teal-600 to-cyan-700",
        reflective: "from-slate-500 via-blue-600 to-indigo-700",
      },
    };
