      ...
      <div className="p-4">
        <div className="bg-black/10 rounded-lg p-6">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h3 className="text-lg font-medium text-white">Error Loading Verse</h3>
              <p className="text-sm text-white/60">{verseReference}</p>
            </div>
          </div>
      ...
      <div className="bg-black/10 rounded-lg p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-medium text-white">{verseData.chapter_name}</h3>
              <p className="text-sm text-white/60">Verse {verseData.verse_number}</p>
            </div>
          </div>
        ...
        {verseData.arabic_text && (
          <div className="mb-4 bg-black/20 rounded-md p-4">
            <p className="text-right font-arabic text-xl leading-loose text-white/90 mb-2">
              {verseData.arabic_text}
            </p>
          </div>
        )}
