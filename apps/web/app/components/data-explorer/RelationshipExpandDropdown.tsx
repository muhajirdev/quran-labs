  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="text-xs bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded-md font-medium flex items-center"
      >
        ...
        <div className="absolute right-0 mt-1 w-36 bg-white rounded-md shadow-lg z-10 border border-gray-200">
          <div className="py-1">
            {direction !== 'incoming' && (
              ...
              >
                <svg className="w-3 h-3 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
