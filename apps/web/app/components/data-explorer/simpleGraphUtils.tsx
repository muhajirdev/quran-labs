...
export function convertToGraphData(results: any): GraphData {
  console.log("Converting query results to graph data:", results);
  ...
  results.data.forEach((row: any) => {
    ...
    Object.keys(row).forEach(column => {
      ...
      if (value._id !== undefined && value._label !== undefined &&
        ...
        console.log(`Generated node ID: ${nodeId} for node:`, value);
        ...
        if (!nodeMap.has(nodeId)) {
          ...
          console.log(`Adding new node to graph:`, node);
          nodeMap.set(nodeId, node);
          graphData.nodes.push(node);
        } else {
          console.log(`Node ${nodeId} already exists in the graph`);
        }
      }
    });
  });
    ...
    Object.keys(row).forEach(column => {
      ...
      if (value && typeof value === 'object' &&
        ...
        if (sourceNode && targetNode) {
          ...
          console.log("Could not find source or target node for relationship");
        }
      }
    });
  });
  ...
  console.log("Final graph data:", {
    ...
    nodeTypes: [...new Set(graphData.nodes.map(n => n.label))],
    relationshipTypes: [...new Set(graphData.links.map(l => l.type))]
  });
