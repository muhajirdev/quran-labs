/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 885e57abc05368495baa2177a7c4dff8)
// Runtime types generated with workerd@1.20250428.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		superquran: KVNamespace;
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare";
		OPENROUTER_API_KEY: string;
		MetaAgent: DurableObjectNamespace<import("./workers/app").MetaAgent>;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "OPENROUTER_API_KEY">> {}
}
